...
import gen.i0.sealights.synth.app.module031.api.Controller024;
...
@DisplayName("Service024Test")
public class Service024Test {

  @Test
  void testAsync000() {
    Service024 service = new Service024();
    Controller024 controller = new Controller024(service);
