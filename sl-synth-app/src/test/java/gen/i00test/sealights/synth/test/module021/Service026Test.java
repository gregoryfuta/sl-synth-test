...
import gen.i0.sealights.synth.app.module021.api.Controller026;
...
@DisplayName("Service026Test")
public class Service026Test {

  @Test
  void testAsync000() {
    Service026 service = new Service026();
    Controller026 controller = new Controller026(service);
