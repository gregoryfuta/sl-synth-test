...
import gen.i0.sealights.synth.app.module023.api.Controller021;
...
@DisplayName("Service021Test")
public class Service021Test {

  @Test
  void testAsync000() {
    Service021 service = new Service021();
    Controller021 controller = new Controller021(service);
