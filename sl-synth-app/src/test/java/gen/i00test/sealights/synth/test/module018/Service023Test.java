...
import gen.i0.sealights.synth.app.module018.api.Controller023;
...
@DisplayName("Service023Test")
public class Service023Test {

  @Test
  void testAsync000() {
    Service023 service = new Service023();
    Controller023 controller = new Controller023(service);
