...
import gen.i0.sealights.synth.app.module005.api.Controller011;
...
@DisplayName("Service011Test")
public class Service011Test {

  @Test
  void testSync000() {
    Service011 service = new Service011();
    Controller011 controller = new Controller011(service);
