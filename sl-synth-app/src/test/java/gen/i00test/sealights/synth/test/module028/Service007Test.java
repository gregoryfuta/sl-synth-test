...
import gen.i0.sealights.synth.app.module028.api.Controller007;
...
@DisplayName("Service007Test")
public class Service007Test {

  @Test
  void testAsync000() {
    Service007 service = new Service007();
    Controller007 controller = new Controller007(service);
