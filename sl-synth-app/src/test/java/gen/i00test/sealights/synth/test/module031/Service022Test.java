...
import gen.i0.sealights.synth.app.module031.api.Controller022;
...
@DisplayName("Service022Test")
public class Service022Test {

  @Test
  void testAsync000() {
    Service022 service = new Service022();
    Controller022 controller = new Controller022(service);
