...
import gen.i0.sealights.synth.app.module002.api.Controller009;
...
@DisplayName("Service009Test")
public class Service009Test {

  @Test
  void testSync000() {
    Service009 service = new Service009();
    Controller009 controller = new Controller009(service);
