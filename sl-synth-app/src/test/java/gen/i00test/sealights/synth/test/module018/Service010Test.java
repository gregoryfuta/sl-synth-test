...
import gen.i0.sealights.synth.app.module018.api.Controller010;
...
@DisplayName("Service010Test")
public class Service010Test {

  @Test
  void testAsync000() {
    Service010 service = new Service010();
    Controller010 controller = new Controller010(service);
